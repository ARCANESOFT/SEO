...
@section('header')
    <h1><i class="fa fa-fw fa-random"></i> {{ trans('seo::redirects.titles.redirections') }} <small>{{ trans('seo::redirects.titles.edit-redirection') }}</small></h1>
@endsection
    ...
    {{ Form::open(['route' => ['admin::seo.redirects.update', $redirect], 'method' => 'PUT', 'class' => 'form form-loading']) }}
        <div class="box">
            <div class="box-header with-border">
                <h2 class="box-title">{{ trans('seo::redirects.titles.update-redirection') }}</h2>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
